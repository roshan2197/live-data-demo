/**
 * Live Data Server with Debezium CDC (Module-based)
 */
...
async function initializeCDC() {
  cdcConsumer = new DebeziumCDCConsumer(
    {
      clientId: 'live-data-node',
    ...
    io,
    {
      ...
      // CDC events are emitted directly to Socket.IO clients in this no-Redis variant.
      realtime: {
  ...
  console.log('? Debezium CDC consumer started');
}
